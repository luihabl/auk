...
void BatchRenderer::setup() {
    ...
    glVertexAttribPointer(3, 3, GL_UNSIGNED_BYTE, GL_TRUE, sizeof(Vertex),
                          (void*)offsetof(Vertex, cmix));
...
void BatchRenderer::draw_tex(const Rect& src,
                             const Rect& dst,
                             float rot,
                             bool centered,
                             const Color& color) {
...
void BatchRenderer::draw_round_rect_line(const Rect& rect,
                                         float radius,
                                         float t,
                                         const Color& color) {
    const int steps = 20;  // TODO: calculate this or pass as an argument
...
void BatchRenderer::draw_triangle_fill(const Vec2& p0,
                                       const Vec2& p1,
                                       const Vec2& p2,
                                       const Color& color) {
...
void BatchRenderer::draw_triangle_line(const Vec2& p0,
                                       const Vec2& p1,
                                       const Vec2& p2,
                                       float t,
                                       const Color& color) {
...
void BatchRenderer::draw_circle_fill(const Vec2& center,
                                     float radius,
                                     const Color& color,
                                     int steps) {
    float cx = center[0];
...
void BatchRenderer::draw_circle_line(const Vec2& center,
                                     float radius,
                                     float t,
                                     const Color& color,
                                     int steps) {
...
void BatchRenderer::draw_arc_fill(const Vec2& center,
                                  float radius,
                                  float radians_start,
                                  float radians_end,
                                  const Color& color,
...
void BatchRenderer::draw_arc_line(const Vec2& center,
                                  float radius,
                                  float radians_start,
                                  float radians_end,
                                  float t,
...
inline void BatchRenderer::push_triangle(const float& x0,
                                         const float& y0,
                                         const float& x1,
                                         const float& y1,
                                         const float& x2,
...
inline void BatchRenderer::push_quad(const float& x0,
                                     const float& y0,
                                     const float& x1,
                                     const float& y1,
                                     const float& x2,
...
inline void BatchRenderer::push_vertex(const float& x,
                                       const float& y,
                                       const float& uv_x,
                                       const float& uv_y,
                                       const Color& color,
...
void BatchRenderer::render_sub_batch(const SubBatch& sb) {
    ...
    // Draw everything
    glDrawElements(GL_TRIANGLES, (GLsizei)sb.index_count, GL_UNSIGNED_INT,
                   (void*)(sizeof(unsigned int) * sb.index_offset));
}
