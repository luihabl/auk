...
template <typename T, size_t M, size_t N>
const Matrix<T, M, N> Matrix<T, M, N>::zeros = MatrixInit::filled<T, M, N>(0);
template <typename T, size_t M, size_t N>
const Matrix<T, M, N> Matrix<T, M, N>::ones = MatrixInit::filled<T, M, N>(1);
template <typename T, size_t M, size_t N>
const Matrix<T, M, N> Matrix<T, M, N>::identity = MatrixInit::identity<T, M, N>();
}  // namespace auk